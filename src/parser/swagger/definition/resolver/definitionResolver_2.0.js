...
let definitionsParamName = "definitions";
...
function resolveDefinition(jsonObject, dbObject) {
    ...
    let definitions;
    if (jsonObject[definitionsParamName]) {
        definitions = jsonObject[definitionsParamName];
        for (const definition in definitions) {
            let definitionObj = jsonObject[definitionsParamName][definition];
